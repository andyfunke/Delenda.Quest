...
GATE_BUNDLE="$(mktemp /tmp/delenda-substrate-gates.XXXXXX.mjs)"
DOCKET_BUNDLE="$(mktemp /tmp/delenda-substrate-docket.XXXXXX.mjs)"
SERVICES_BUNDLE="$(mktemp /tmp/delenda-substrate-services.XXXXXX.mjs)"
PARSER_BUNDLE="$(mktemp /tmp/delenda-substrate-parser.XXXXXX.mjs)"
AVA_BUNDLE="$(mktemp /tmp/delenda-substrate-ava.XXXXXX.mjs)"
INDEX_BUNDLE="$(mktemp /tmp/delenda-substrate-index.XXXXXX.mjs)"
LLM_BUNDLE="$(mktemp /tmp/delenda-substrate-llm.XXXXXX.mjs)"
MCP_BUNDLE="$(mktemp /tmp/delenda-substrate-mcp.XXXXXX.mjs)"
