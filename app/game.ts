import { diplomacyCircuit, domesticCircuit, executeCircuit, forceGenerationCircuit, operationsCircuit, productionCircuit, type DiplomacyLedger, type DiplomaticActor, type DomesticLedger, type ForceGenerationLedger, type OperationsLedger, type ProductionLedger, type TrainingCohort } from "./circuits";
...
export type GameState = {
  ...
  maintenanceDebt: number; productionLedger: ProductionLedger | null; operationsLedger:OperationsLedger|null; domesticLedger:DomesticLedger|null; diplomacyLedger:DiplomacyLedger|null;actors:DiplomaticActor[];
