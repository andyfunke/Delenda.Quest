...
export type AvaExecutionRecord = {
...
export type GameState = {
  ...
  avaExecutions:AvaExecutionRecord[];
...
export type CampaignPhaseId=import("./campaign-substrate").CampaignPhaseId;
...
export const initialState = (input:Partial<CampaignConfig>={}): GameState => {
  ...
  const s:GameState={
    ...
    currentSubMissions:null,subMissionHistory:[],resolutionHistory:[],dailyDockets:[],preparedOrders:[],avaExecutions:[],reports: [],
  };
...
export const restoreCampaignState=(value:unknown):GameState|null=>{
  ...
  const state:GameState={...base,...candidate,saveVersion:4,contentPackVersion:CONTENT_PACK_VERSION,campaignSeed:sanitizeSeed(candidate.campaignSeed??base.campaignSeed),theater,
    ...
    avaExecutions:Array.isArray(candidate.avaExecutions)?candidate.avaExecutions as AvaExecutionRecord[]:base.avaExecutions,
