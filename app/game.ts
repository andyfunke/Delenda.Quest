...
export const FAMILIES: Family[] = [
  ...
  // Append-only: Ava's P-handles are derived from this registry's flattened order.
  // New families belong at the tail so existing terminal commands remain stable.
