...
export function AccountPage({onNewCampaign}:{onNewCampaign:()=>void}){
  ...
  const load=useCallback(async()=>{
    try{
      ...
      setData({authenticated:false,signIn:"/signin-with-chatgpt?return_to=%2Fgame%3Faccount%3D1"});
    }
  },[]);
