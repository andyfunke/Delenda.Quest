...
export function AccountPage({onNewCampaign}:{onNewCampaign:()=>void}){
  ...
  const changeTimeZone=async()=>{
    ...
    try{
      ...
      await load();setNotice("PRIVATE DAY BOUNDARY UPDATED");
